...
export function Chat(props: {
  ...
  updateSubmit: (state: number) => void;
}) {
  ...
  const onUserSubmit = () => {
    ...
    setAutoScroll(true);
    props.updateSubmit(session.messages.length)
  };
          ...
          return (
            ...
            >
              <div className={styles["chat-message-container"]}>
                ...
                {isUser && (message.preview || message.streaming) ? <></> : <div className={styles["chat-message-item"]}>
                  {!isUser &&
